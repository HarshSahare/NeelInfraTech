    ...
    <section className="w-full bg-white py-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 md:grid-rows-2  h-[600px]">
        ...
        <div className="relative md:row-span-2 md:col-span-2">
          ...
          />
          <div className="absolute px-[69px] font-classica font-[400] bottom-0 left-0 h-[50%] flex flex-col justify-end w-full bg-black/40 text-white p-4 text-base md:text-lg">
