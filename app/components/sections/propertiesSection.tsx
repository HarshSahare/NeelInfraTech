...
const PropertiesSection = () => {
  return (
    <section className="w-[95.5%] min-h-svh flex flex-col justify-center ml-auto pl-6 mt-[174px] py-12">
      <div className="flex flex-col lg:flex-row justify-between  gap-12">
        ...
        <div className="lg:w-1/3 mt-[115px]">
          ...
          <h2 className="text-4xl font-classica font-[400] mt-4 mb-[40px] leading-snug">
            Discover Our <br /> Newest Residential Property
          </h2>
          <p className="text-[#6A5F6C] text-[11px]/[20px] font-poppins mb-[48px]">
          ...
          <button
            className="border border-black text-[#747176] hover:bg-black hover:text-white transition text-[12px]  font-poppins tracker-[1px] rounded-full"
