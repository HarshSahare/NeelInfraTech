...
const StorySection = () => {
  return (
    <section className="bg-white py-16 px-4 md:px-20 text-center">
      ...
      <div className="mt-[130px] grid grid-cols-1 md:grid-cols-3 gap-12 max-w-5xl mx-auto text-left">
      ...
      <div className="mt-12">
        <button className="bg-black text-white px-18 py-3 mt-[130px]  text-sm hover:bg-gray-900 transition">
          Discover Our Story
        </button>
      </div>
    </section>
